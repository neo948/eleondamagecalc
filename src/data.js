...
for (let ty in types) {
    items.push(ty.chart(0).toUpperCase() + ty.slice(1) + " Essence");
    items.push(types[ty].otherName.chart(0).toUpperCase() + types[ty].otherName.slice(1) + " Pearl");
    items.push(types[ty].otherName.chart(0).toUpperCase() + types[ty].otherName.slice(1) + " Shell");
}
