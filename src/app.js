...
function calculateStat(base, IV, EV, level, isHP = false, posNat, negNat, veryNat, name, rest = false) {
    let stat;
...
function detailedReport() {
    ...
    let adaptiveResult;
    let atkDef;
    if ((move.name == "Last Resort" || move.name == "Special Attack") && atks.ranged > atks.melee 
